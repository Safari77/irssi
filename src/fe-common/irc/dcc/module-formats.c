...
FORMAT_REC fecommon_irc_dcc_formats[] = {
	...
	{ "dcc_send_complete", "{dcc DCC sent file {dccfile $0} [{hilight $1}] for {nick $2} in {hilight $3} [{hilight $4 KiB/s}]}", 5, { 0, 0, 0, 0, 3 } },
	...
	{ "dcc_get_complete", "{dcc DCC received file {dccfile $0} [$1] from {nick $2} in {hilight $3} [$4 KiB/s]}", 5, { 0, 0, 0, 0, 3 } },
	...
	{ "dcc_list_line_file", "{dcc  $0 $1: %|$2 of $3 ($4%%) - $5 KiB/s - ETA $7 - $6}", 8, { 0, 0, 0, 0, 1, 3, 0, 0 } },
